...
class Message(object):
    ...
    def apply_pad(self, pad):
        ...
        for x in range(length):
            result = result + (self.shift_char(list_text[x], pad[x]))    
        return result
...
class PlaintextMessage(Message):
    def __init__(self, input_text, pad=None):
        ...
        self.chiphertext = self.apply_pad(self.pad)
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        for i in pad:
            copy_pad.append(-i)
        decrypted_text = self.apply_pad(copy_pad)
        result = PlaintextMessage(decrypted_text, pad)
        return result
